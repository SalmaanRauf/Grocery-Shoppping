...
///////////////////////// TO-DO (2) //////////////////////////////
  /// Copying the parameters into the object's attributes (member variables) "works" but is not correct.  Be sure to move the parameters into the object's attributes
    //initializer list 
    : _upcCode    { std::move(upcCode)}, //copy move
      _brandName  { std::move(brandName)}, //using constructor initialization list
...
GroceryItem & GroceryItem::operator=( GroceryItem const & rhs ) &
{
  ///////////////////////// TO-DO (5) //////////////////////////////
    ...
    // all assignment operators do return self/me/this
    return * this;
  /////////////////////// END-TO-DO (5) ////////////////////////////
}
...
// upcCode()
//not just copying, we want to steal the resources, move them. we want to get rid of OG
...
// brandName(...)
///////////////////////// TO-DO (16) //////////////////////////////
GroceryItem & GroceryItem::brandName(const std::string newBrandName) &
{
...
// productName(...)
///////////////////////// TO-DO (17) //////////////////////////////
GroceryItem & GroceryItem::productName(const std::string newProductName) &
{
...
// price(...)
///////////////////////// TO-DO (18) //////////////////////////////
GroceryItem & GroceryItem::price(const double newPrice) &
{
    _price = newPrice;
    return *this;
}
...
std::weak_ordering GroceryItem::operator<=>( const GroceryItem & rhs ) const noexcept
{
  ...
  ///////////////////////// TO-DO (19) //////////////////////////////
  auto output = _upcCode <=> rhs._upcCode;
  if(output != 0) return output;

  output = _productName <=> rhs._productName;
  if(output != 0) return output;
  
   output = _brandName <=> rhs._brandName;
  if(output != 0) return output;
